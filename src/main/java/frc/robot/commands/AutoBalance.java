...
public class AutoBalance extends CommandBase {
  PIDController initPidController = new PIDController(0.027, 0, 0); //0.027, 0, 0
  PIDController finalPidController = new PIDController(0.01, 0.001, 0); //TUNE (Make it smaller)
